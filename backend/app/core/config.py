...
class Settings(BaseSettings):
    # Database
    DATABASE_URL: str = "postgresql+asyncpg://postgres:postgres@postgres:5432/futurhn"
    ...
    # Product pricing
    PRODUCTS: dict = {
        "future_hn_pack_3": {"price": 799, "generations": 3},
        "future_hn_pack_10": {"price": 1999, "generations": 10},
    }
